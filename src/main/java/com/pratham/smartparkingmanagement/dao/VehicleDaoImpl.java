...
public class VehicleDaoImpl implements VehicleDao {
    ...
    public void create(Vehicle vehicle) {
        ...
        String sql =
                "INSERT INTO Vehicle " +
                "(plate_number, vehicle_type, owner_id) " +
                "VALUES (?, ?, ?)";
        ...
        try (Connection connection = DBConfig.getConnection();
            ...
            statement.setString(
                    2,
                    vehicle.getVehicleType().getDbCode()
            );
    ...
    @Override
    public Vehicle findByIdForUpdate(
            Connection conn,
            int vehicleId
    ) throws SQLException {
    ...
    @Override
    public Optional<Vehicle> findByPlateNumber(
            String plateNumber) {
        ...
        try (Connection connection =
            ...
            throw new RuntimeException(
                    "Failed to find vehicle by plate",
                    e
            );
        }
