...
public class TicketDaoImpl implements TicketDao {
    ...
    public void create(
        ...
        String sql =
                ...
                "created_by, overstayed_flag, lost_ticket_flag) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        try (PreparedStatement statement =
            ...
            statement.setBoolean(
                    6,
                    ticket.isOverstayedFlag()
            );

            statement.setBoolean(
                    7,
                    ticket.isLostTicketFlag()
            );
    ...
    @Override
    public Optional<Ticket> findActiveByVehicle(
            int vehicleId) {

        try (Connection connection =
                     DBConfig.getConnection()) {

            return findActiveByVehicle(
                    connection,
                    vehicleId
            );
    ...
    @Override
    public List<Ticket> findByVehicleId(
            int vehicleId) {
        ...
        try (Connection connection =
            ...
            throw new RuntimeException(
                    "Failed to fetch tickets by vehicle",
                    e
            );
        }
