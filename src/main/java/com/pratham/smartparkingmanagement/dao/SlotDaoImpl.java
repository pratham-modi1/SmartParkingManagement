...
public class SlotDaoImpl implements SlotDao {
    ...
    public void create(Slot slot) {
        ...
        String sql =
                "INSERT INTO Slot " +
                "(slot_label, vehicle_type, status, parking_lot_id) " +
                "VALUES (?, ?, ?, ?)";
    ...
    @Override
    public List<Slot> findAvailableByLotAndType(
            int lotId,
            VehicleType type) {
    ...
    @Override
    public Slot findFirstAvailableForUpdate(
            Connection conn,
            int lotId,
            VehicleType type
    ) throws SQLException {
